                ...
                <div className="flex flex-col w-1/5 mx-[1%]">
                    ...
                    <div className="flex-grow font-sourgummy w-full mb-[6%]">
                        <div className="w-full flex flex-row justify-center">
                            <button><img src={githubImage} className="bg-black text-white rounded-lg border-2 border-white mx-2 drop-shadow-white" alt="GitHub" /></button> 
                            <button><img src={devpostImage} className="bg-black text-white rounded-lg border-2 border-white mx-2 drop-shadow-white" alt="Devpost" /></button> 
                            <button><img src={ctfImage} className="bg-black text-white rounded-lg border-2 border-white mx-2 drop-shadow-white" alt="CTFTime" /></button> 
                        </div>
                    </div> 
                </div>
                <div className="flex flex-col w-3/5">
                    <div className="opacity-90 rounded-lg font-acme font-light text-5xl text-neutral-900 text-center flex-none h-[6%] w-[50%] mx-auto bg-white my-[2%]">
                        |Yoshixis Web|
                    </div>
